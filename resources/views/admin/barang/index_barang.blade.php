            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <p class="text-xs text-secondary mb-0">{{$barang->harga}}</p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0">{{$barang->deskripsi}}</p>
                  </td>
                  <td>
                    <p class="text-xs text-secondary mb-0">@if( $barang->foto)
                      <img  style="width: 80px; height:80px;" src="{{url('sampah_images').'/'.$barang->foto}}" alt="">
                    @endif</p>
                  </td>
